...
import br.org.aacc.doacao.MVP.Welcome.IWelcome;
import br.org.aacc.doacao.MVP.Welcome.PresenterWelcome;
...
public class WelcomeActivity extends _SuperActivity implements View.OnClickListener,IWelcome.IViewWelcome {
   ...
   // private GoogleApi googleApi;
    ...
    public void GoogleWidgets ()
    {
        ...
        signInButton.setOnClickListener((View.OnClickListener) _context);
    }
    @Override
    ...
    private void signIn() {
        try {
            ...
            TrackHelper.WriteError(_context, "signIn", e.getMessage());
        }
    }
    @Override
